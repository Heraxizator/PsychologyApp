...
public sealed class DatabaseInitializerIdempotencyIntegrationTests : IAsyncLifetime
{
    ...
    [Fact]
    public async Task InitializeAsync_CalledTwice_ResolvesTechniqueCatalog()
    {
