...
namespace PsychologyApp.Domain.ValueObjects;
...
public class ColourMeaning : ValueObject
{
    ...
    public static ColourMeaning From(string explaination, ColourMeaningType colourMeaningType)
    {
        ...
        return !SupportedColourMeanings.Contains(ColourMeaning) ? throw new UnsupportedColourMeaningException("Значение выбранного цвета не поддерживается") : ColourMeaning;
    }
    ...
    public static ColourMeaning BrownVoted => new(ColourMeaningType.Wanted,
    ...
    public static ColourMeaning BrownUnvoted => new(ColourMeaningType.Unwanted,
    ...
    {
        yield return this.Explaination ?? string.Empty;
    }
}
