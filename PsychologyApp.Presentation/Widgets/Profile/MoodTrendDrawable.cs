...
public sealed class MoodTrendDrawable : IDrawable
{
    ...
    public void Draw(ICanvas canvas, RectF dirtyRect)
    {
        ...
        for (int i = 0; i < Points.Count; i++)
        {
            ...
            float normalized = (Points[i].MoodLevel - minScore) / scoreRange;
        ...
        canvas.DrawString("1", padding, dirtyRect.Bottom - padding, dirtyRect.Width / 2, 14, HorizontalAlignment.Left, VerticalAlignment.Top);
        canvas.DrawString("5", padding, padding, dirtyRect.Width / 2, 14, HorizontalAlignment.Left, VerticalAlignment.Top);
    }
}
