...
public sealed class RevealOnAppearingBehavior : Behavior<VisualElement>
{
    ...
    private void OnPageAppearing(object? sender, EventArgs e)
    {
        ...
        if (RevealOnTabAppearOnly)
        {
            ...
            {
                UiAnimations.SafeRevealLiteAsync(
                    _attachedView,
                    y: UiAnimations.TabReappearSlideOffset,
                    allowHidden: true).FireAndForget();
            }
    ...
    private async Task RevealInitialAsync()
    {
        ...
        _hasRevealedThisSession = true;
        await UiAnimations.SafeRevealPremiumAsync(_attachedView, y: UiAnimations.SlideOffset, allowHidden: true);
    }
