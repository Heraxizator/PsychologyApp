...
internal static class TechniqueCatalogEnglish
{
    internal static readonly Dictionary<TechniqueId, TechniqueDefinition> Definitions = new()
    {
        ...
        [TechniqueId.Hack] = new(
            ...
            TechniqueUiKind.None, "Technique #6", "30.01.2023", "White spot", "Neutralizing memories", "Episodes", "NLP"),
        [TechniqueId.Experience] = new(
            ...
            TechniqueUiKind.None, "Technique #7", "08.02.2023", "Experience modification", "Working through limits, beliefs, and behavior", "Episodes", "Filip Slavinski"),
        ...
        [TechniqueId.Resize] = new(
            ...
            TechniqueUiKind.None, "Technique #10", "22.01.2025", "Shrink it", "Simple importance-lowering technique", "Importance", "NLP"),
        [TechniqueId.Check] = new(
            ...
            TechniqueUiKind.None, "Technique #11", "22.01.2025", "Check it", "Simple importance-lowering technique", "Importance", "NLP")
    };
}
